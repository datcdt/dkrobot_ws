...
namespace dkrobot_base
{
    ...
    { 
        ...
        pub_wheel_cmd_velocities_ = nh_.advertise<dkrobot_msgs::WheelsCmdStamped>("wheel_cmd_velocities", 10);
        ...
        sub_encoder_ticks_ = nh_.subscribe("encoder_ticks", 10, &DkroBotHWInterface::encoderTicksCallback, this);
    ...
    void DkroBotHWInterface::printState()
    {
    ...
    std::string DkroBotHWInterface::printStateHelper()
    {
        std::stringstream ss;
    ...
    std::string DkroBotHWInterface::printCommandHelper()
    {
        std::stringstream ss;
        std::cout.precision(15);
    ...
    void DkroBotHWInterface::encoderTicksCallback(const dkrobot_msgs::EncodersStamped::ConstPtr& msg_encoder)
    {
