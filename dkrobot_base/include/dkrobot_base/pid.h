...
#include <dkrobot_base/ParametersConfig.h>
...
namespace dkrobot_base
{
    ...
    public:
        ...
        void updateDynamicReconfig(dkrobot_base::ParametersConfig config);

        /**
         * \brief Update the PID parameters from dynamics reconfigure
         */
        void dynamicReconfigCallback(dkrobot_base::ParametersConfig &config, uint32_t /*level*/);
    ...
    private:
        ...
        typedef dynamic_reconfigure::Server<dkrobot_base::ParametersConfig> DynamicReconfigServer;
