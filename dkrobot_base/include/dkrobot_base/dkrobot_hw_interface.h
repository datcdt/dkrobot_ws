#ifndef DKROBOT_HW_INTERFACE_H
#define DKROBOT_HW_INTERFACE_H
...
namespace dkrobot_base
{
    ...
    class DkroBotHWInterface : public hardware_interface::RobotHW
    {
    public:
        /**
         * \brief Constructor
         ...
         */
        DkroBotHWInterface(ros::NodeHandle &nh, urdf::Model *urdf_model = NULL);

        /** \brief Destructor */
        virtual ~DkroBotHWInterface() {}
